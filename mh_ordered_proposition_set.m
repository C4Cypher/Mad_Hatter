...
:- func max(mh_ordered_proposition_set) = int is det.
:- pred max(mh_ordered_proposition_set::in, int::out) is det.

:- func semidet_max(mh_ordered_proposition_set) = int is semidet.
:- pred semidet_max(mh_ordered_proposition_set::in, int::out) is semidet.
